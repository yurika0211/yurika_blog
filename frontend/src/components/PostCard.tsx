  ...
  post: BlogPost;
    ...
    export default function PostCard({ post }: PostCardProps) {
      return (
        ...
        <article className="bg-slate-100/50 dark:bg-gray-900/30 p-6 rounded-lg shadow-sm border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all">
