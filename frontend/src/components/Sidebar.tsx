...
export default function Sidebar() {
  ...
  return (
    <aside className="lg:col-span-30 space-y-8 lg:pl-10">
      {/* 模块 1: 个人简介卡片 */}
      <SearchWidget />
      <div className="bg-slate-100/50 dark:bg-gray-900/30 backdrop-blur-sm p-6 rounded-xl shadow-sm border border-gray-100 dark:border-gray-800 transition-colors">
