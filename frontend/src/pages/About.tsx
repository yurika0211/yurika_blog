...
export default function ChatProfile() {
 ...
 return (
    <div className="paper-sheet my-4 mx-auto flex h-[calc(100vh-3rem)] w-full max-w-5xl flex-col overflow-hidden">
      <div className="z-10 flex items-center justify-between border-b border-[color:var(--hair)] bg-[color:var(--paper)] p-4 dark:border-[color:var(--hair)] ">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="absolute bottom-0 right-0 h-2.5 w-2.5 rounded-full border-2 border-[color:var(--hair)] bg-green-500 dark:border-[color:var(--hair)]"></div>
            <img
 src={APP_AVATAR_SRC}
 alt="Avatar"
 ...
 yurika
            ...
            <p className="text-xs font-medium text-[color:var(--seal)]">
              Rust & React Developer
            </p>
          </div>
        </div>
        <div className="flex gap-2 text-[color:var(--ink-soft)]">
          <Phone className="h-5 w-5 cursor-pointer hover:text-[color:var(--ink)]" />
          <MoreVertical className="h-5 w-5 cursor-pointer hover:text-[color:var(--ink)]" />
        </div>
      </div>
 ...
 className="flex-1 space-y-6 overflow-y-auto bg-transparent p-4"
      >
        {historyLoading && (
          <div className="text-center text-xs text-[color:var(--ink-soft)] dark:text-[color:var(--ink-soft)]">
 ...
 className="h-8 w-8 flex-shrink-0 rounded-full object-cover"
            ...
            <div
 className={`max-w-[80%] rounded-[0.16rem] px-4 py-3 text-sm leading-relaxed ${
 msg.role === "user"
                  ? "rounded-br-none bg-[color:var(--seal)]/80 text-white"
                  : "rounded-bl-none border border-[color:var(--hair)] bg-white/50 text-[color:var(--ink)] dark:border-[color:var(--hair)]  "
              }`}
            >
              <div className="whitespace-pre-wrap">
                ...
                {msg.id === streamingMessageId && (
                  <span
 aria-hidden="true"
 className="ml-0.5 inline-block animate-pulse text-[color:var(--seal)] dark:text-[color:var(--seal)]"
                  >
                    {STREAMING_CURSOR}
                  </span>
                )}
 ...
 className="ml-0 h-8 w-8 rounded-full object-cover"
            />
            <div className="flex gap-1 rounded-[0.16rem] rounded-bl-none border border-[color:var(--hair)] bg-[color:var(--paper)] px-4 py-3 dark:border-[color:var(--hair)] ">
      ...
      <form
 onSubmit={handleSend}
 className="border-t border-[color:var(--hair)] bg-[color:var(--paper)] p-4 dark:border-[color:var(--hair)] "
      >
        <div className="flex items-center gap-2">
          <input
 type="text"
 ...
 className="flex-1 rounded-full bg-[color:var(--paper)] px-5 py-3 text-sm text-[color:var(--ink)] transition-all focus:outline-none focus:ring-2 focus:ring-blue-500  "
          />
          <button
 type="submit"
 disabled={!input.trim() || isTyping}
 className="transform rounded-full bg-[color:var(--seal)] p-3 text-white transition-all hover:scale-105 hover:bg-[color:var(--seal)] hover: active:scale-95 disabled:cursor-not-allowed disabled:opacity-50"
          >
