        ...
        <div className="flex flex-wrap gap-2">
          {allTags.map(tag => (
            <Link
              key={tag}
              to={`/tag/${tag}`}
              className="px-3 py-1 rounded-lg text-sm bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 hover:bg-blue-100 dark:hover:bg-blue-900 hover:text-blue-600 dark:hover:text-blue-300 transition-colors"
            >
              #{tag}
            </Link>
          ))}
