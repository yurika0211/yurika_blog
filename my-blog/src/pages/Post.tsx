...
export default function Post() {
  ...
  const coverSrc = coverImage || '/bg.png';
  ...
  return (
    <div className="w-full">
      ...
      <section className="bg-white dark:bg-gray-950 py-8 md:py-10 transition-colors">
          ...
          <div className="flex gap-8">
            ...
            <section className="mt-10 border-t border-gray-200 dark:border-gray-800 pt-8">
              ...
              {isLoggedIn ? (
                <div className="mt-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-4">
                  <div className="grid gap-3">
                    <input
                      ...
                      placeholder="你的昵称（可选）"
                      className="w-full rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-800 dark:text-gray-100 outline-none transition focus:border-blue-500"
                    />
                    <textarea
                      value={content}
                      ...
                      placeholder="写下你的评论..."
                      rows={3}
                      className="w-full resize-none rounded-md border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 px-3 py-2 text-sm text-gray-800 dark:text-gray-100 outline-none transition focus:border-blue-500"
                    />
                ...
                <div className="mt-4 rounded-xl border border-dashed border-gray-300 bg-gray-50 px-4 py-3 text-sm text-gray-600 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                  当前为只读模式，登录后可新增或删除评论。
            ...
            <aside className="hidden xl:block w-64 shrink-0">
              <div className="sticky top-[12%] rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 transition-colors">
